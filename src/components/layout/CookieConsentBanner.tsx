...
const CookieConsentBanner = () => {
    ...
    return (
        <div className="fixed flex-col text-center md:text-left md:flex-row text-xs md:text-sm bottom-2 md:bottom-0 left-0 z-[999999] bg-primary/80 text-white w-full flex gap-4 justify-between px-8 py-4 items-center ">
