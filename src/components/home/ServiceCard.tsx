...
const ServiceCard = ({ logoSrc, title, description }: ServiceCardProps) => {
	return (
		<div className='flex flex-col gap-2 justify-between text-center text-sm items-center bg-white text-black rounded-xl w-full h-[300px] py-6 px-4 md:h-auto md:gap-1 md:items-start md:w-[30%] md:text-lg md:py-4 md:px-4 3xl:px-8 3xl:w-[27%] 3xl:h-[300px] 3xl:py-8'>
